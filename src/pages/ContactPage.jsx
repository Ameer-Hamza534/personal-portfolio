        ...
        >
          <div className="">
            ...
            <div className="flex justify-center space-x-4">
              <Link
                to="mailto:itishamza.pk@gmail.com"
                aria-label="Send an email to itishamza.pk@gmail.com"
                className={twMerge(
              ...
              <Link
                to="https://wa.me/923218155205?text=Hello!%20I%20would%20like%20to%20discuss%20a%20project."
                className={twMerge(
