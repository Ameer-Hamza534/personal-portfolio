...
import clerk from "../../assets/skills/Clerk_dark.svg";
import router from "../../assets/skills/reactrouter.svg";
...
export default function Skills() {
  ...
  const repeatedLogos = Array(3).fill(logos).flat();
  return (
    <>
      <motion.section
        ref={sectionRef}
        ...
        className="w-full mx-auto min-h-screen bg-[#0F1012]  rounded-t-[40px] md:rounded-t-[60px] flex items-center justify-center flex-col overflow-hidden"
      >
